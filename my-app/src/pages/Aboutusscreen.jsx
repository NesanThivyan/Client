...
import Ambulance from '../images/Ambulance.png'; // Assuming you have an ambulance image
const AboutUsSection = () => {
  ...
  <div className="w-full max-w-6xl mx-auto rounded-lg shadow-lg overflow-hidden bg-white">
    {/* Top Gradient Banner */}
    <div className="relative h-50 bg-gradient-to-r from-blue-700 to-purple-800"></div>

    {/* About Section */}
    <div className="relative bg-gradient-to-r from-blue-700 to-purple-800 p-8 md:p-12 -mt-48 z-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
      {/* Left: Text Content */}
